...
from advanceoptionWindow import Ui2 
...
class Controller:
    ...
    def show_Ui(self):
        self.ui = Ui()
        self.ui.switch_window.connect(self.show_Ui2)
        self.ui.show()

    def show_Ui2(self):
        self.window = Ui2()
        self.window.switch_window.connect(self.show_Ui)
        self.ui.hide()
        self.window.show()
